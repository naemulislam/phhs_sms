...
@section('title','Admin & Teacher login')
@section('content')
    <!--begin::Main-->
            ...
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        <!--begin::Form-->
                        <form action="{{route('schoolPortal.store')}}" method="POST" class="form"
                            id="kt_login_signin_form">
                            @csrf
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark">Welcome to Signin Into Admin $ Teacher</h3>
                                <span class="text-muted font-weight-bold font-size-h4">New Here?
                                    <a href="javascript:;" id="kt_login_signup"
                                        class="text-primary font-weight-bolder">Create an Account</a></span><br>
                                        <span class="text-small">(Only teacher can create an account)</span>
                            </div>
                            <!--begin::Title-->
                            <!--begin::Form group-->
                    ...
                    <div class="login-form login-signup">
                        ...
                        <form class="form" action="" method="POST" id="kt_login_signup_form">
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Sign Up As Teacher
                                </h3>
                            ...
                            <div class="form-group">
                                ...
                                <div style="color:red;padding:0 5px;">
                                    {{ $errors->has('phone') ? $errors->first('phone') : '' }}</div>
                            </div>
                            <div class="form-group">
                                <label for="">PDS ID Number<span class="text-danger">*</span></label>
                                <input class="form-control" type="number" placeholder="type your pds id" name="pds_id" />
                                <div style="color:red;padding:0 5px;">
                                    {{ $errors->has('pds_id') ? $errors->first('pds_id') : '' }}</div>
                            </div>
