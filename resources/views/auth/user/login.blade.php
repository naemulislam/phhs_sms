            ...
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        <!--begin::Form-->
                        <form action="{{ route('userLogin.store')}}" method="POST" class="form" id="kt_login_signin_form">
                            @csrf
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark">Welcome to Signin Into Users
                                </h3>
                    ...
                    <div class="login-form login-signup">
                        ...
                        <form class="form" action="{{route('user.register')}}" method="POST" id="kt_login_signup_form">
                            ...
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Sign Up As User
                                </h3>
