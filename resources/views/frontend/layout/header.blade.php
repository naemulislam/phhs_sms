            ...
            <div class="menu-area">
                <ul>
                    ...
                    <li class="dd-btn1"><a href="#">শিক্ষার্থীদের তথ্য <i class="fa fa-angle-down"></i></a>
                        ...
                        <div class="dropdown-menu1">
                            <ul>
                                <li><a href="{{ route('school.students')}}"><i class="fa fa-long-arrow-right"></i> ক্লাস-6</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> ক্লাস-7</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> ক্লাস-8</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> ক্লাস-9</a></li>
                    ...
                    <li class="dd-btn1"><a href="#">একাডেমিক তথ্য <i class="fa fa-angle-down"></i></a>
                        <div class="dropdown-menu1">
                            <ul>
                                <li><a href="{{ route('class.routin')}}"><i class="fa fa-long-arrow-right"></i> ক্লাস রুটিন</a></li>
                                <li><a href="{{ route('sylebus')}}"><i class="fa fa-long-arrow-right"></i> পাঠ্যক্রম </a></li>
                                <li><a href="{{ route('exam.routin')}}"><i class="fa fa-long-arrow-right"></i> পরীক্ষার রুটিন</a></li>
                    ...
                    <li class="dd-btn1"><a href="#">গ্যালারি <i class="fa fa-angle-down"></i></a>
                        <div class="dropdown-menu1">
                            <ul>
                                <li><a href="{{ route('gallery.picture')}}"><i class="fa fa-long-arrow-right"></i> ফটো গ্যালারি</a></li>
                    ...
                    <li class="dd-btn1"><a href="#">আরো <i class="fa fa-angle-down"></i></a>
                        ...
                        <div class="dropdown-menu1">
                            <ul>
                                <li class="dd-btn2"><a href="{{ route('contact')}}"><i class="fa fa-long-arrow-right"></i>যোগাযোগ</a></li>
                                <li class="dd-btn2"><a href="{{ route('school.staff')}}"><i class="fa fa-long-arrow-right"></i>স্টাফদের তথ্য</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> নতুন কমিটি</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> পুরাতন কমিটি</a></li>
                                <li><a target="_blank" href="{{ asset('frontend/assets/images/pdf/mpo_info.pdf')}}"><i class="fa fa-long-arrow-right"></i> এমপিও ও জাতীয়করনের তথ্য</a></li>
                    ...
                    <li class="dd-btn1"><a href="#">পোর্টাল <i class="fa fa-angle-down"></i></a>
                        ...
                        <div class="dropdown-menu1">
                            <ul>
                                <li class="dd-btn2"><a href="{{ route('school.portal')}}"><i class="fa fa-long-arrow-right"></i> School Portal<i class="fa fa-angle-right float-right mt-1"></i></a></li>
                                <li class="dd-btn2"><a href="{{ route('student.portal')}}"><i class="fa fa-long-arrow-right"></i> Student Portal<i class="fa fa-angle-right float-right mt-1"></i></a></li>
                                <li class="dd-btn2"><a href="{{ route('user.login')}}"><i class="fa fa-long-arrow-right"></i> User Portal<i class="fa fa-angle-right float-right mt-1"></i></a></li>
                            </ul>
                        </div>
        ...
        <div class="accordion" id="accordionExample">
            ...
            <div class="menu-box">
                <div class="menu-link" id="headingTwo">
                    <a class="mmenu-btn" type="button" data-toggle="collapse" data-target="#collapseTwo">শিক্ষকদের তথ্য<i
            ...
            <div class="menu-box">
                <div class="menu-link" id="headingThree">
                    <a class="mmenu-btn" type="button" data-toggle="collapse" data-target="#collapseThree">শিক্ষার্থীদের তথ্য<i
                            class="fa fa-plus"></i></a>
                </div>
                <div id="collapseThree" class="collapse menu-body" aria-labelledby="headingThree"
                    ...
                    <div class="card-body">
                        <ul>
                            <li><a href="{{ route('school.students')}}"><i class="fa fa-long-arrow-right"></i>ক্লাস-6</a></li>
                            <li><a href=""><i class="fa fa-long-arrow-right"></i> ক্লাস-7</a></li>
                            <li><a href=""><i class="fa fa-long-arrow-right"></i> ক্লাস-8</a>
                            <li><a href=""><i class="fa fa-long-arrow-right"></i> ক্লাস-9</a>
                            <li><a href=""><i class="fa fa-long-arrow-right"></i> ক্লাস-10</a>
                            </li>
            ...
            <div class="menu-box">
                <div class="menu-link" id="headingFour">
                    <a class="mmenu-btn" type="button" data-toggle="collapse" data-target="#collapseFour">একাডেমিক তথ্য<i
                            class="fa fa-plus"></i></a>
                </div>
            ...
            <div class="menu-box">
                <div class="menu-link" id="headingFive">
                    <a class="mmenu-btn" type="button" data-toggle="collapse" data-target="#collapseFive">গ্যালারি<i
                            class="fa fa-plus"></i></a>
                </div>
            ...
            <div class="menu-box">
                ...
                <div id="collapseSix" class="collapse menu-body" aria-labelledby="headingSix"
                    ...
                    <div class="card-body">
                        <ul>
                            <li>
                                <a href="{{ route('contact')}}"><i class="fa fa-long-arrow-right"></i> যোগাযোগ</a></li>
                                <li><a href="{{ route('school.staff')}}"><i class="fa fa-long-arrow-right"></i> স্টাফদের তথ্য</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> নতুন কমিটি</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> পুরাতন কমিটি</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i> এমপিও ও জাতীয়করনের তথ্য</a></li>
            ...
            <div class="menu-box">
                <div class="menu-link" id="headingSeven">
                    <a class="mmenu-btn" type="button" data-toggle="collapse" data-target="#collapseSeven">পোর্টাল<i
                            class="fa fa-plus"></i></a>
                </div>
                <div id="collapseSeven" class="collapse menu-body" aria-labelledby="headingSeven"
                    ...
                    <div class="card-body">
                        <ul>
                            <li><a href="{{ route('school.portal')}}"><i class="fa fa-long-arrow-right"></i> School Portal</a></li>
                                <li><a href="{{ route('student.portal')}}"><i class="fa fa-long-arrow-right"></i> Student Portal</a></li>
                                <li><a href="{{ route('user.login')}}"><i class="fa fa-long-arrow-right"></i> User Portal</a></li>
