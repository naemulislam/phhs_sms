            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Gallery List
                            <span class="d-block text-muted pt-2 font-size-sm">All gallery image here</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('gallery.create')}}"  class="btn btn-primary font-weight-bolder">
                    ...
                    <table class="table" id="dataTableB4">
                        ...
                        <tbody>
                            ...
                            <img style="width:150px ;" src= "{{ asset('storage/'.$row->image)}}" alt="">
                                ...
                                <td class="d-flex">
                                    <a href="{{route('gallery.edit',$row->id)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3"><i class="fa fa-edit"></i></a>


                                    <a id="delete" href="{{ route('gallery.destroy',$row->id)}}" class="btn btn-icon btn-danger btn-hover-primary btn-xs mx-3">
                            ...
                            <div class="modal fade" data-backdrop="static" id="row_status_{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('gallery.status',$row->id)}}" method="post">
                                            @csrf
