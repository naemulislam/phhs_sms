                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="@if (Auth::user()->role == 'admin') {{ route('gallery.create') }} @endif"
                            ...
                            <tbody>
                                @foreach ($gallerys as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($row->image)
                                                <img style="width:150px ;" src= "{{ asset('storage/' . $row->image) }}"
                                                    alt="">
                                            @else
                                                <img style="width:150px ;" src= "{{ asset('defaults/noimage/no_img.jpg') }}"
                                                    alt="">
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        @if (Auth::user()->role == 'admin')
                                            <td class="d-flex">
                                                ...
                                                <a id="delete" href="{{ route('gallery.destroy', $row->id) }}"
