                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" name="subject"
                                class="form-control"
                                value="{{ auth::user()->teacher->subject->name }}" placeholder="Subject" readonly/>
                        </div>
                    </div>
                </div>
                @endif
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="date" name="date_of_birth"
                                class="form-control"
                                value="{{ auth::user()->teacher->date_of_birth }}" placeholder="Date of Birth"/>
                        </div>
                        @error('date_of_birth')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" name="religion"
                                class="form-control"
                                value="{{ auth::user()->teacher->religion }}" placeholder="Religion"/>
                        </div>
                        @error('religion')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <select name="gender" class="form-control">
                                ...
                                <option {{ Auth::user()->teacher->gender == 'male' ? 'selected': '' }} value="male">Male</option>
                                <option {{ Auth::user()->teacher->gender == 'female' ? 'selected': '' }} value="female">Female</option>
                            </select>
                        </div>
                        @error('gender')
                                <span class="text-danger">{{ $message }}</span>
