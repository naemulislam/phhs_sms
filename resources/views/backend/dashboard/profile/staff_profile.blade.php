                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <input class="form-control form-control-lg form-control-solid" type="file" name="image"
                                onchange="loadFile(event)" accept=".png, .jpeg, .jpg" />
                            @error('image')
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <div class="input-group input-group-lg input-group-solid">
                                ...
                                <select name="gender" class="form-control">
                                    ...
                                    <option {{ Auth::user()->staff->gender == 'male' ? 'selected' : '' }} value="male">
                                        Male</option>
                                    <option {{ Auth::user()->staff->gender == 'female' ? 'selected' : '' }} value="female">
                                        Female</option>
                                </select>
                            </div>
                            @error('gender')
                    ...
                    <div class="row">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="same"
                                value="1">
