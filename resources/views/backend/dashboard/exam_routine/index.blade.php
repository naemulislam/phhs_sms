...
@section('content')
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Exam Routine</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Exam Routine List
                                ...
                                @foreach ($examRoutines as $row)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a id="delete" href="{{ route('exam.routine.destroy', $row->id) }}"
                                    ...
                                    <div class="modal fade" id="row_status_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('exam.routine.status', $row->id) }}" method="post">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="editmodal_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('exam.routine.update', $row->id) }}"
    ...
    <div class="modal fade" id="addmodal" tabindex="-1" data-backdrop="static" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Exam Routine</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="fa fa-close"></i>
                    </button>
                </div>
                <form action="{{ route('exam.routine.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exam_type" placeholder="Enter exam type"
                                        class="form-control" value="{{ old('exam_type') }}">
                                    @error('exam_type')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
