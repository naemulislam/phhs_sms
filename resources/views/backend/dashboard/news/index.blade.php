                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="@if (Auth::user()->role == 'admin') {{ route('news.create') }} @endif"
                            ...
                            <tbody>
                                @foreach ($newss as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->date }}</td>
                                        <td><a href="#"
                                                class="btn label label-lg label-light-secondary label-inline text-danger p-3"
                                        ...
                                        @if (Auth::user()->role == 'admin')
                                            <td class="d-flex">
                                                ...
                                                <a id="delete" href="{{ route('news.destroy', $row->id) }}"
