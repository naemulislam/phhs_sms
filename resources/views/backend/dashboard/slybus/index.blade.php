...
@section('content')
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Slybus</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Class wise Slybus List
                                <span class="d-block text-muted pt-2 font-size-sm">All slybus here</span>
                            </h3>
                        </div>
                                ...
                                @foreach ($slybuss as $row)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a id="delete" href="{{ route('slybus.destroy', $row->id) }}"
                                    ...
                                    <div class="modal fade" id="row_status_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('slybus.status', $row->id) }}" method="post">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="editmodal_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Edit Slybus</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <i class="fa fa-close"></i>
                                                    </button>
                                                </div>
                                                <form action="{{ route('slybus.update', $row->id) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="">Slybus type <span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="text" name="slybus_type"
                                                                        placeholder="Enter slybus type" class="form-control"
                                                                        value="{{ $row->slybus_type }}">
                                                                    @error('slybus_type')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
    ...
    <div class="modal fade" id="addmodal" tabindex="-1" data-backdrop="static" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Slybus</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="fa fa-close"></i>
                    </button>
                </div>
                <form action="{{ route('slybus.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Slybus type <span class="text-danger">*</span></label>
                                    <input type="text" name="slybus_type" placeholder="Enter slybus type"
