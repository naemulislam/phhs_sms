                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href=" @if (Auth::user()->role == 'admin') {{ route('notice.create')}} @endif"
                                ...
                                @foreach ($notices as $notice)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($notice->document)
                                                <a target="_blank"
                                                    href="{{ asset('storage/' . $notice->document) }}">Document</a>
                                            @else
                                                Blank
                                            @endif
                                        </td>
                                        <td>
                                            @if ($notice->is_active == 1)
                                                <a href="#"
                                                    ...
                                                    data-toggle="modal"
                                                    @if (Auth::user()->role == 'admin') data-target="#row_status_{{ $notice->id }}" @endif>
                                                    Active</a>
                                        ...
                                        @if (Auth::user()->role == 'admin')
                                            <td class="d-flex">
                                                ...
                                                <a id="delete" href="{{ route('notice.destroy', $notice->id) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" class="form-control">
                                                                <option value="1"
                                                                    @if ($notice->is_active == 1) selected @endif>Active
                                                                </option>
                                                                <option value="0"
                                                                    @if ($notice->is_active == 0) selected @endif>
                                                                    Inactive</option>
                                                            </select>
