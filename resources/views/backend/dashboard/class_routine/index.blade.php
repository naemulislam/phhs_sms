...
@section('content')
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Class Routine</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Class Routine List
                                <span class="d-block text-muted pt-2 font-size-sm">All routine here</span>
                            </h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="" data-toggle="modal" @if(Auth::user()->role == 'admin') data-target="#addmodal" @endif
                            ...
                            <tbody>
                                @foreach ($classRoutines as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($row->document)
                                                <a class="btn-sm btn-secondary text-danger" target="_blank" href="{{asset('storage/'.$row->document)}}">Document</a>
                                            @else
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a id="delete" href="{{ route('class.routine.destroy', $row->id) }}"
                                    ...
                                    <div class="modal fade" id="row_status_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('class.routine.status', $row->id) }}"
                                                    method="post">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="editmodal_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Edit Class Routine</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <i class="fa fa-close"></i>
                                                    </button>
                                                </div>
                                                <form action="{{ route('class.routine.update', $row->id) }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="year" placeholder="Enter year" class="form-control" value="{{ $row->year}}">
                                                                    @error('year')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                        ...
                                        <option {{ $row->group_id == $group->id ? 'selected': ''}} value="{{ $group->id}}">{{ $group->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="section" placeholder="Enter section" class="form-control" value="{{ $row->section}}">
                                                                    @error('section')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="shift" placeholder="Enter shif" class="form-control" value="{{ $row->shift}}">
                                                                    @error('shift')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
    ...
    <div class="modal fade" id="addmodal" tabindex="-1" data-backdrop="static" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Class Routine</h5>
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Year <span class="text-danger">*</span></label>
                                    <input type="number" name="year" placeholder="Enter year" class="form-control" value="{{ date('Y')}}">
                                    @error('year')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
