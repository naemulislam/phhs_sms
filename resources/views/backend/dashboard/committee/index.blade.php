                ...
                <div class="card card-custom mb-4">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="@if (Auth::user()->role == 'admin') {{ route('committee.create') }} @endif"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img style="width:70px ;"
                                                src="{{ $row->image ? asset('storage/' . $row->image) : asset('defaults/noimage/no_img.jpg') }}"
                                                alt="">
                                        </td>
                                        <td>{{ $row->name }}</td>
                                                ...
                                                <form action="{{ route('committee.status', $row->id) }}" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" class="form-control">
                                                                <option value="1"
                                                                    @if ($row->is_active == 1) selected @endif>
                                                                    Active
                                                                </option>
                                                                <option value="0"
                                                                    @if ($row->is_active == 0) selected @endif>
