                                ...
                                @foreach ($groups as $row)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a id="delete" href="{{ route('group.destroy',$row->id)}}" class="btn btn-icon btn-danger btn-hover-primary btn-xs mx-3">
                                    ...
                                    <!--Row Status -->
                                    <div class="modal fade" id="row_status_{{ $row->id }}" data-backdrop="static" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('group.status', $row->id) }}" method="post">
                                                    @csrf
                                    ...
                                    <!-- Edit Modal -->
                                    <div class="modal fade" id="editmodal_{{ $row->id }}" data-backdrop="static" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('group.update', $row->id) }}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('group.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">Class Name</label>
                            <input type="text" name="name" placeholder="Class name" class="form-control">
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
