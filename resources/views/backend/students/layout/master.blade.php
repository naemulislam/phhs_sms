...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            <!--begin::Aside-->
            @include('backend.students.layout.includes.aside')
            <!--end::Aside-->
            <!--begin::Wrapper-->
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="{{ route('home') }}" target="_blank"
                                class="text-dark-75 text-hover-primary">Purbo Hoktullah High School</a>
                        </div>
                        <!--end::Nav-->
                    </div>
                    <!--end::Container-->
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    ...
                    <div class="symbol-label"
                        style="background-image:url(@if (Auth::user()->profile_id) {{ Auth::user()->image->file }} @else {{ asset('defaults/avatar/avatar.png') }} @endif)">
                    </div>
                    ...
                    <div class="navi mt-2">
                        <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span
                                    class="navi-text text-muted text-hover-primary">{{ Auth()->user()->email }}</span></span>
                        </a>
